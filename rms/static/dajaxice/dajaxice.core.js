...
var Dajaxice = {
    ...
    day_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.day_check', 'POST', callback_function, argv, custom_settings);
    },

    updateprofile: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.updateprofile', 'POST', callback_function, argv, custom_settings);
    },

    updatecombo: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.updatecombo', 'POST', callback_function, argv, custom_settings);
    },

    book_m: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.book_m', 'POST', callback_function, argv, custom_settings);
    },

    time_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.time_check', 'POST', callback_function, argv, custom_settings);
    },

    start_date_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.start_date_check', 'POST', callback_function, argv, custom_settings);
    },

    date_check_new: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.date_check_new', 'POST', callback_function, argv, custom_settings);
    },

    book_all_day_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.book_all_day_event', 'POST', callback_function, argv, custom_settings);
    },

    single_booking_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.single_booking_check', 'POST', callback_function, argv, custom_settings);
    },

    multiple_booking_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.multiple_booking_check', 'POST', callback_function, argv, custom_settings);
    },

    time_check_new: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.time_check_new', 'POST', callback_function, argv, custom_settings);
    },

    end_date_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.end_date_check', 'POST', callback_function, argv, custom_settings);
    },

    both_date_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.both_date_check', 'POST', callback_function, argv, custom_settings);
    },

    updateinfo: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.updateinfo', 'POST', callback_function, argv, custom_settings);
    },

    date_check: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.date_check', 'POST', callback_function, argv, custom_settings);
    },

    book_s: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.book_s', 'POST', callback_function, argv, custom_settings);
    },

    cancel_booking: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.cancel_booking', 'POST', callback_function, argv, custom_settings);
    },

    eInfo: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.eInfo', 'POST', callback_function, argv, custom_settings);
    },

    update_check_new: function(callback_function, argv, custom_settings){
        return Dajaxice.call('dashboard.update_check_new', 'POST', callback_function, argv, custom_settings);
    },
